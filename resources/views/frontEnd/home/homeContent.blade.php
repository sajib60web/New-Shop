                ...
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        ...
                        <div class="women">
                            ...
                            <p ><del>{{$newProduct->old_price}}</del> <em class="item_price">{{$newProduct->new_price}}</em></p>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p14.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p13.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p15.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p16.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p18.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p17.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p20.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p19.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p21.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p22.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p24.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p23.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                    ...
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p26.jpg" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p25.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>
                                        ...
                                        <div  class="grid-arrival">
                                            <figure>		
                                                <a href="single.html">
                                                    ...
                                                    <div class="grid-img">
                                                        <img  src="{{asset('/')}}/frontEnd/images/p9.jpg" class="img-responsive"  alt="">
                                                    </div>			
                                                </a>		
                                            </figure>	
                                        </div>

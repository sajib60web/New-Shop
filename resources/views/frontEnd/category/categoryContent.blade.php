...
<div class="banner1">
    <div class="container">
        <h3><a href="{{route('/')}}">Home</a> / <span>Product</span></h3>
    </div>
</div>
<!--banner-->
<!--content-->
        ...
        <div class="container">
            <div class="product-agileinfo-grids w3l">
                <div class="col-md-3 product-agileinfo-grid">
                            ...
                            <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
                                <ul>
                                    <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                        <ul>
                                            <li><a href="products.html">Shir                                                                                                                                                                            ts</a></li>
                    ...
                    <div class="cat-img">
                        <img class="img-responsive " src="{{asset('/')}}frontEnd/images/45.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-9 product-agileinfon-grid1 w3l">
                    <div class="product-agileinfon-top">
                        <div class="col-md-6 product-agileinfon-top-left">
                            <img class="img-responsive " src="{{asset('/')}}frontEnd/images/img1.jpg" alt="">
                        </div>
                        <div class="col-md-6 product-agileinfon-top-left">
                            <img class="img-responsive " src="{{asset('/')}}frontEnd/images/img2.jpg" alt="">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                                        ...
                                        <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                            <div class="grid-arr">
                                                ...
                                                <div class="women">
                                                    ...
                                                    <p ><del>Tk : {{$categoryProduct->old_price}}</del>/ <em class="item_price">Tk : {{$categoryProduct->new_price}}</em></p>
                                    ...
                                    <div class="product-tab1">
                                        ...
                                        <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                            ...
                                            <div class="women">
                                                <h6><a href="{{route('product-details',['id'=>$categoryProduct->id])}}">{{$categoryProduct->product_name}}</a></h6>
                                                <span class="size">XL / XXL / S </span>
                                                <p style="text-align: justify">{{$categoryProduct->short_description}}</p>
                                                <p ><del>Tk :{{$categoryProduct->old_price}}</del>/ <em class="item_price">Tk : {{$categoryProduct->new_price}}</em></p>
                                                <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                            </div>
                                        </div>

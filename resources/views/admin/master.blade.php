                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Category Option<span class="fa arrow"></span></a>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Barend Option<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{route('add-brand')}}">Add Barend</a>
                                    </li>
                                    <li>
                                        <a href="{{route('manage-brand')}}">Manage Barend</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Product Option<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav                                            -second-level">
                                    <li>
                                        <a href="blank.html">Blank Pag                                            e</a>
                                    </li>
                                    <                                            li>
